...
#    angle[3] = angle[3]%(360)
    ...
    while (Solved) and not rospy.is_shutdown():
        ...
        hello_str =  JointState() #'%f,%f,%f,%f'%(angle[0],angle[1],angle[2],angle[3])
        ...
        #print(err_p)
        hello_str.name = ['Lshoulder_joint', 'Larm_joint', 'Lelbow_joint', 'Lhand_joint']
        hello_str.position = [angle[0], angle[1], angle[2], angle[3]]
        hello_str.velocity = []
        hello_str.effort = []
