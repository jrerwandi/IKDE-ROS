...
link1 = 17.7209
link2 = 4.9194
link3 = 24.7906+2.6717#20.76945 + 2.724
link4 = 30.71505


link1 = 17.7209
link2 = 6.307396304
link3 = 20.7906+2.6717
...
link1 = 17.7209
link2 = 4.9194 #+ 1.694
link3 = 23.46245 + 1.7194
link4 = 30.68395 + 1.592805723#+ 1.592805723
...
def publish():
    ...
    '''
    pub = rospy.Publisher('robotis/set_joint_states/', JointState, queue_size = 100)
...
#    target = [50, 14, -14]
    ...
    while ((err_p > 1 or err_r > 1) and Done == False):
       if ulang >= 5:
          Done = True
          print("+++++++++++++++++++++++++++++++++")
          print("IK ERROR")
